...
5. **Security Memory Synchronization**: You are authorized to write structural summaries of active vulnerabilities and attack flows directly into Section 7 of `project_memory.md`. You must use the strict LIFO format for these logs.
